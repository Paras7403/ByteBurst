...
using namespace std;
int main() {
    cout << "Welcome to ByteBurst";
    return 0;
}`,
    c: `#include <stdio.h>
int main() {
    printf("Welcome to ByteBurst");
    return 0;
}`,
    java: `class Main {
    public static void main(String[] args) {
        System.out.println("Welcome to ByteBurst");
    }
}`,
    python3: `print("Welcome to ByteBurst")`,
    go: `package main
import "fmt"
func main() {
    fmt.Println("Welcome to ByteBurst")
}`,
    javascript: `console.log("Welcome to ByteBurst")`,
  };
